...
#include "es7210_adc.h"  // For ES7120_SEL_MIC* defines
...
esp_codec_dev_handle_t bsp_audio_codec_microphone_init(void)
{
    ...
    // Configure ES7210 with proper microphone selection (matching codec_board)
    es7210_codec_cfg_t es7210_cfg = {
        .ctrl_if = i2c_ctrl_if,
        .mic_selected = ES7120_SEL_MIC1 | ES7120_SEL_MIC3,  // Select MIC1 and MIC3 channels
    };
    ...
    esp_codec_dev_handle_t mic_dev = esp_codec_dev_new(&codec_es7210_dev_cfg);

    // Set microphone input gain (matching codec_board's 30.0 dB)
    if (mic_dev != NULL) {
        esp_codec_dev_set_in_gain(mic_dev, 30.0);
        ESP_LOGI(TAG, "Microphone initialized with MIC1|MIC3, gain=30.0dB");
    }
