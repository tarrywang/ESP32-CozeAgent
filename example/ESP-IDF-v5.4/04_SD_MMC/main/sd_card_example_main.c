...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(i2c_param_config(IIC_HOST, &i2c_conf));
    ESP_ERROR_CHECK(i2c_driver_install(IIC_HOST, i2c_conf.mode, 0, 0, 0));

    esp_io_expander_handle_t io_expander = NULL;
    esp_io_expander_new_i2c_tca9554(IIC_HOST, ESP_IO_EXPANDER_I2C_TCA9554_ADDRESS_000, &io_expander);

    ESP_ERROR_CHECK(esp_io_expander_new_i2c_tca9554(IIC_HOST, ESP_IO_EXPANDER_I2C_TCA9554_ADDRESS_000, &io_expander));
