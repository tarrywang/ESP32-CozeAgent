...
esp_err_t ioexpander_init(void)
{   
    esp_err_t ret = ESP_OK;
    esp_io_expander_new_i2c_tca9554(I2C_MASTER_NUM, ESP_IO_EXPANDER_I2C_TCA9554_ADDRESS_000, &io_expander);
    esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_5 |IO_EXPANDER_PIN_NUM_4, IO_EXPANDER_INPUT);
    return ret;
}
