...
extern "C" void app_main(void)
{
    ...
    // Note: BSP already configures rounder callback correctly in bsp_display_lcd_init()
    // Rotation is disabled by default; uncomment below if 180° rotation is needed
    // if (disp != NULL)
    // {
